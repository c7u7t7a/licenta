...
# This prevents Pygame from crashing when running over SSH without a monitor!
...
def getJS(name=''):
    ...
    # axis 0: Left Stick L/R | axis 1: Left Stick U/D 
    # axis 3: Right Stick L/R | axis 4: Right Stick U/D
...
def main():
    # Test print to see if it's reading the controller
    print("JoyStick Data:", getJS()) 
    sleep(0.05)
